...
public class GymSystemExtendedTest {
    ...
    public static double testClassManagement() {
        ...
        try {
            ...
            if (registered && trainer.getListOfClasses().get(0).getAvialableSeats() == 0 && trainer.getListOfRegistration().get(0).getSearchKey().equals("M001C001")) {
    ...
    public static double testRegistrationManagement() {
        ...
        try {
            ...
            if (cancelled && trainer.getListOfClasses().get(1).getAvialableSeats() == 30) {
